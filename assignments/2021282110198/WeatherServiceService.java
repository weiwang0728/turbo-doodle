 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceService", targetNamespace = "http://Weather/", wsdlLocation = "http://localhost:8085/ws_server/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICESERVICE_QNAME = new QName("http://Weather/", "WeatherServiceService");
    ...
    public WeatherService getWeatherServicePort() {
        return super.getPort(new QName("http://Weather/", "WeatherServicePort"), WeatherService.class);
    }
    ...
    public WeatherService getWeatherServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Weather/", "WeatherServicePort"), WeatherService.class, features);
    }
